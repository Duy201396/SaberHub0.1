...
local Window = OrionLib:MakeWindow({Name = "Saber Huh", HidePremium = false, IntroText = "Saber Library", SaveConfig = true, ConfigFolder = "Saber Hub"})
----------Tab-----------------------
...
elseif World3 then
	tableBoss = {"Saber Hub Raid Boss [Lv. 3000]","Stone","Island Empress","Kilo Admiral","Captain Elephant","Beautiful Pirate","rip_indra True Form","Longma","Soul Reaper","Cake Queen"}
end
